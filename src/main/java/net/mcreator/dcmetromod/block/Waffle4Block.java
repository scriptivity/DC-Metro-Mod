...
public class Waffle4Block extends DcMetroModModElements.ModElement {
	@ObjectHolder("dc_metro_mod:waffle_4")
	public static final Block block = null;

	public Waffle4Block(DcMetroModModElements instance) {
		super(instance, 7);
	}
