...
public class Waffle3Block extends DcMetroModModElements.ModElement {
	@ObjectHolder("dc_metro_mod:waffle_3")
	public static final Block block = null;

	public Waffle3Block(DcMetroModModElements instance) {
		super(instance, 3);
	}
