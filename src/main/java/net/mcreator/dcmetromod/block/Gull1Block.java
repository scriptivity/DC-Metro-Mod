...
public class Gull1Block extends DcMetroModModElements.ModElement {
	@ObjectHolder("dc_metro_mod:gull_1")
	public static final Block block = null;

	public Gull1Block(DcMetroModModElements instance) {
		super(instance, 12);
	}
