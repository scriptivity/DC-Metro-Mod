...
package net.mcreator.dcmetromod.block;
...
public class Gull2SupportsBlock extends DcMetroModModElements.ModElement {
	@ObjectHolder("dc_metro_mod:gull_2_supports")
	public static final Block block = null;

	public Gull2SupportsBlock(DcMetroModModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("gull_2_supports");
		}
