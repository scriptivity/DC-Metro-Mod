...
public class Waffle6Block extends DcMetroModModElements.ModElement {
	@ObjectHolder("dc_metro_mod:waffle_6")
	public static final Block block = null;

	public Waffle6Block(DcMetroModModElements instance) {
		super(instance, 9);
	}
