...
public class Waffle7Block extends DcMetroModModElements.ModElement {
	@ObjectHolder("dc_metro_mod:waffle_7")
	public static final Block block = null;

	public Waffle7Block(DcMetroModModElements instance) {
		super(instance, 11);
	}
