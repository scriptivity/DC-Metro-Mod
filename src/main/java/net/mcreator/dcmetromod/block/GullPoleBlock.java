...
public class GullPoleBlock extends DcMetroModModElements.ModElement {
	@ObjectHolder("dc_metro_mod:gull_pole")
	public static final Block block = null;

	public GullPoleBlock(DcMetroModModElements instance) {
		super(instance, 14);
	}
